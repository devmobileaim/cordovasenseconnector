...
/**
 *  SFK_ERROR_CODE_OSMOSYS_FILE
 *
 *  This error code means that the osmosys.properties file
 *  is not present or wrongly implemented.
 */
extern NSInteger const SFK_ERROR_CODE_OSMOSYS_FILE;
 ...
 *
 *  This error code means that the adding of a new item failed.
 */
