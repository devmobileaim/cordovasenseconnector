 ...
 */
extern NSString * const SFKSQLCipherOptionsCipherPageSize;
 ...
 */
extern NSString * const SFKSQLCipherOptionsCipher;
 ...
 */
extern NSString * const SFKSQLCipherOptionsKDFIter;
 ...
 *  @return The secure Core Data otherwise returns nil
 */
+ (id<SFKSecureCoreDataProtocol>)secureCoreDataWithBundlePath:(NSString *)bundlePath storePath:(NSString *)storePath;
